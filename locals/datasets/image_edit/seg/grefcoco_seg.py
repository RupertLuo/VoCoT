...
class GrefCOCODataset(Dataset):
    def __init__(
        ...
        color_list_file_path='datasets/image_edit/prompt/color_list_train_small.txt'
        self.color_list=[]
    ...
    def __getitem__(self, i: int) -> dict[str, Any]:
        ...
        return {'input_images': [image_0], 'output_images': [image_1],
                'output_cond_images': [image_0], 'conversation': sources, 'image_label_masks': [0, 1]}