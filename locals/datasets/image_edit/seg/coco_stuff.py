...
class COCOStuffDataset(Dataset):
    def __init__(
        ...
        seg_diverse_prompt_path = 'datasets/image_edit/prompt/prompt_seg.txt'
        ...
        color_list_file_path='sft_datasets/image_edit/prompt/color_list_train_small.txt'
        self.color_list=[]
        ...
        coco_label_list_path = os.path.join(self.path, 'labels.txt')
        self.label_dict={}
    ...
    def get_processed_image(self, i):
        ...
        mask_path = os.path.join(self.path, "images", self.split, image_id + ".png")
